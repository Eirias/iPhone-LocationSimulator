...
> The bundled `go-ios` is **MIT-licensed** (Copyright 2019 danielpaulus). Its license text ships
> next to the binary (`GoIOSKit/.../Resources/go-ios.LICENSE`) as MIT requires. Keep it with the
> binary in any redistribution. See also [`NOTICE`](NOTICE).
